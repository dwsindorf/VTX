...
static char *H2O_sol_str="solid(Color(1.00,1.00,1.00),Color(0.41,0.79,0.78),273,1,0.95,40,1,0.2,noise(GRADIENT|NABS|SCALE|SQR,15,9,0.1,0.4,1.8,0.73,-0.34,0,0))";
