...
enum {
	...
	ID_OCEAN  		= ID_LEVEL2|ID_TERRAIN | ID_FUNC | 0x0003,
	ID_SNOW         = ID_LEVEL2|ID_TERRAIN | ID_FUNC | 0x0004,
	ID_MAP  		= ID_LEVEL2|ID_TERRAIN | ID_FUNC | 0x0005,
	ID_SPRITE  	    = ID_LEVEL3|ID_TERRAIN | ID_FUNC | 0x0001,
	ID_PLANT  	    = ID_LEVEL3|ID_TERRAIN | ID_FUNC | 0x0002,
	ID_ROCK3D  	    = ID_LEVEL3|ID_TERRAIN | ID_FUNC | 0x0003,
	ID_CLOUD  	    = ID_LEVEL4|ID_TERRAIN | ID_FUNC | 0x0001,
	ID_ROCKS  	    = ID_LEVEL6|ID_TERRAIN | ID_FUNC | ID_BASE | 0x0003,
	
	ID_STATE 	    = ID_LEVEL7|ID_TERRAIN | ID_EVAL | 0x0001,
	ID_LIQUID 	    = ID_LEVEL7|ID_TERRAIN | ID_EVAL | 0x0002,
	ID_SOLID 	    = ID_LEVEL7|ID_TERRAIN | ID_EVAL | 0x0003,
	...
	//ID_MAP  		= ID_TERRAIN | ID_FUNC | 0x0008,
	ID_FCHNL  		= ID_TERRAIN | ID_FUNC | 0x0009,
	ID_PLACED  		= ID_TERRAIN | ID_FUNC | ID_BASE | 0x0000,
	ID_LAYER  		= ID_TERRAIN | ID_FUNC | ID_BASE | 0x0001,
	ID_BRANCH  	    = ID_TERRAIN | ID_FUNC | ID_BASE | 0x0002,
	ID_LEAF  	    = ID_TERRAIN | ID_FUNC | ID_BASE | 0x0003,
	ID_CRATERS  	= ID_TERRAIN | ID_FUNC | ID_BASE | 0x0004,
