...
Point           MapPt;
double          Slope=0,Hardness,Theta,Phi,Temp=0,Tave=0,Tsol=0,Tgas=0,Sfact=0,MapTemp=0,Height=0.0,PX,PY,Radius=0,Density=0,Range=0,MaxHt=0,MinHt=0,FHt=0,Randval=0,Srand=0,Level=0;
Scope          *CurrentScope;
