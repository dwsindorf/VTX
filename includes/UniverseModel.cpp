...
//	cout << "p:"<< parent->typeName() << endl;
	...
	case TN_SYSTEM:
		f=1000*LY;
		((System*)child)->origin=Point(f*SRand(),f*SRand(),f*SRand());
		break;
	case TN_PLANET:
...
"			bands(\"mercury\",64,0.5,0.5,RAND,Color(1,1,0.7,0.5));\n"
"           Surface {\n"
"				surface=craters(4,0.2,0.05,1,1,0.8)\n"
"				        Z(noise(RO1|UNS,1,5,0.5,0.2)+0.2*noise(RIDGED,11,4,0.5,0.5))\n"
"				        +Color(1-0.7*PZ,RED,RED)\n"
"				        +Texture(\"mercury\",S,0.2*noise(0,2,1,0.5,2)+0.01*HT);\n"
"            }\n"
"		}\n"
"		Planet(0.003,50) {\n"
"			shine=0.2;\n"
...
"			year=100;\n"
"			tilt=10;\n"
"			emission=Color(1,0,0,0.05);\n"
"           Surface {\n"
"				surface=craters(2,0.1,0.1,1,1,0.8)\n"
"                       Z(0.1*noise(ERODED,11,4,0.5,0.5))\n"
"                       +Color(noise(UNS,1,5,0.3,0.2),0.8*RED,0.3*RED);\n"
"           }\n"
"			Clouds(0.003+100 miles) {\n"
"				shine=0.2;\n"
"				albedo=0.1;\n"
"				emission=Color(1,0,0,0.05);\n"
"				tilt=0;\n"
"				day=30;\n"
"				Surface{\n"
"				    terrain=Color(0.5*twist(0.6+0.1*noise(RIDGED,3,4,1,0.5,2,1),noise(UNS,3,4,1,0.5,2,0.53))+0.2,0.8*RED,0.3*RED,1);\n"
"				}\n"
"			}\n"
"		}\n"
"		Planet(0.0036,85) {  \n"
